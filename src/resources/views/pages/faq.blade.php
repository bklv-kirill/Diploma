    ...
    <div class="faq">
        ...
        <div class="faq-accordion-container">
            ...
            <div class="ac">
                ...
                <div class="ac-panel">
                    <ul class="ac-text">
                        <li>- Откликаться на вакансии могут только зарегистрированные пользователи. Если у вас еще нет
                            аккаунта на сайте, вы можете
                            <a href="{{ route('user.login') }}">зарегистрировать</a> его за пару минут. Помните, что
            ...
            <div class="ac">
                ...
                <div class="ac-panel">
                    <ul class="ac-text">
                        <li>- Вы так же можете сменить и дату рождения, которую ранее указывали при заполнении профиля.
