...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Blade::component('auth-register-text', \App\View\Components\Forms\Modules\AuthRegister\Text::class);
        Blade::component('password-input', \App\View\Components\Forms\Modules\Password\Input::class);

        // Модалки.
        Blade::component('main-modal', \App\View\Components\Modals\MainModal::class);

        // Модули.
        Blade::component('user-avatar', \App\View\Components\Modules\User\Avatar::class);
        Blade::component('user-edit-contact', \App\View\Components\Modules\Pages\User\Edit\Contact::class);
        Blade::component('user-profile-specification', \App\View\Components\Modules\Pages\User\Profile\Specification::class);
